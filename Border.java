...
public class Border extends Box {
  ...
  public Border(Triple uL, Triple uR, Triple dR, Triple dL) {
    ...
    this.northEast =
      new Vertex(
        new Triple(
          this.upRight.position.x,
          this.upRight.position.y - this.depth,
          0
        ),
        this.color
      );
    this.northWest =
      new Vertex(
        new Triple(
          this.upLeft.position.x,
          this.upLeft.position.y - this.depth,
          0
        ),
        this.color
      );
    ...
    this.eastSouth =
      new Vertex(
        new Triple(
          this.dnRight.position.x - this.depth,
          this.dnRight.position.y,
          0
        ),
        this.color
      );
    this.eastNorth =
      new Vertex(
        new Triple(
          this.upRight.position.x - this.depth,
          this.upRight.position.y,
          0
        ),
        this.color
      );
    ...
    this.southEast =
      new Vertex(
        new Triple(
          this.dnRight.position.x,
          this.dnRight.position.y + this.depth,
          0
        ),
        this.color
      );
    this.southWest =
      new Vertex(
        new Triple(
          this.dnLeft.position.x,
          this.dnLeft.position.y + this.depth,
          0
        ),
        this.color
      );
    ...
    this.westNorth =
      new Vertex(
        new Triple(
          this.upLeft.position.x + this.depth,
          this.upLeft.position.y,
          0
        ),
        this.color
      );
    this.westSouth =
      new Vertex(
        new Triple(
          this.dnLeft.position.x + this.depth,
          this.dnLeft.position.y,
          0
        ),
        this.color
      );
